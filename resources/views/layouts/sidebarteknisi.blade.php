<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link   {{ request()->path() == 'teknisi/dashboard' ? 'active' : ''}} " href="/teknisi/dashboard">
            ...
            <li class="nav-item">
                {{-- cara menambahkan link active --}}
                {{-- <a class="nav-link {{ Request::path() === '/teknisi/teknisi' ? 'bg-primary' : '' }} " href="/teknisi/teknisi"> --}}
                <a class="nav-link  {{ request()->path() == 'teknisi/teknisi' ? 'active' : ''}} " href="/teknisi/teknisi">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                {{-- cara menambahkan link active --}}
                {{-- <a class="nav-link {{ Request::path() === '/teknisi/teknisi' ? 'bg-primary' : '' }} " href="/teknisi/teknisi"> --}}
                <a class="nav-link  {{ request()->path() == 'teknisi/pelapor' ? 'active' : ''}} " href="/teknisi/pelapor">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-person-circle" viewBox="0 0 16 16">
                    ...
                    <span class="nav-link-text ms-1">Data Pelapor</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link   {{ request()->path() == 'teknisi/pengaduan' ? 'active' : ''}} " href="/teknisi/pengaduan">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->path() == 'teknisi/doing' ? 'active' : ''}} " " href="/teknisi/doing">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-boombox-fill" viewBox="0 0 16 16">
                            <path
                    ...
                    <span class="nav-link-text ms-1">Laporan (Dikerjakan)</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ request()->path() == 'teknisi/selesai' ? 'active' : ''}} " href="/teknisi/selesai">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link   {{ request()->path() == 'teknisi/feedback' ? 'active' : ''}} " href="/teknisi/feedback">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Umpan Balik</span>
                </a>
            </li>
