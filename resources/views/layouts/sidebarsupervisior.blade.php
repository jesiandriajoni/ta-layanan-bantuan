<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white"
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link {{ request()->path() == 'supervisor/dashboard' ? 'active' : ''}}" href="/supervisor/dashboard">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->path() == 'supervisor/ratting' ? 'active' : ''}}" href="/supervisor/ratting">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Ratting Teknisi</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ request()->path() == 'supervisor/pengaduan' ? 'active' : ''}}" href="/supervisor/pengaduan">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->path() == 'supervisor/pelanggan' ? 'active' : ''}}" href="/supervisor/pelanggan">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
