<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-white">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->path() == 'admin/ratting' ? 'active' : ''}}" href="/admin/ratting">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link  {{ request()->path() == '' ? 'active' : ''}}" href="#" data-bs-toggle="collapse" data-bs-target="#collapseOne1"
                ...
                <div id="collapseOne1" class="accordion-collapse collapse" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body text-sm opacity-8">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->path() == 'admin/karyawan' ? 'active' : ''}}" " href="/admin/karyawan">
                                    <div
                                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
                                            <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->path() == 'admin/teknisi' ? 'active' : ''}}" " href="/admin/teknisi">
                                    <div
                                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body text-sm opacity-8">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link  {{ request()->path() == 'admin/pelanggan' ? 'active' : ''}}" href="/admin/pelanggan">
                                    <div
                                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                        <svg class="text-dark" width="16px" height="16px" viewBox="0 0 45 40"
            ...
            {{-- <li class="nav-item">
                <a class="nav-link " href="#" data-bs-toggle="collapse" data-bs-target="#collapseOne2"
                    aria-expanded="false" aria-controls="collapseOne">
                    ...
                    <span class="nav-link-text ms-1">Data Master Pengaduan</span>
                </a>
                <div id="collapseOne2" class="accordion-collapse collapse" aria-labelledby="headingOne"
                    ...
                    <div class="accordion-body text-sm opacity-8">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link  " href="/admin/jenispengaduan">
                                    <div
                                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                                        <svg class="text-dark" width="16px" height="16px" viewBox="0 0 45 40"
                                            version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <span class="nav-link-text ms-1">Jenis Pengaduan</span>
                                </a>
                            </li>
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->path() == 'admin/pengaduan' ? 'active' : ''}}" href="/admin/pengaduan">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->path() == 'admin/feedback' ? 'active' : ''}}" href="/admin/feedback">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Umpan Balik Pelanggan</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link  {{ request()->path() == 'admin/event' ? 'active' : ''}}" href="/admin/event">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->path() == 'admin/databandwidth' ? 'active' : ''}}" href="/admin/databandwidth">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Data Bandwidth</span>
                </a>
            </li>
