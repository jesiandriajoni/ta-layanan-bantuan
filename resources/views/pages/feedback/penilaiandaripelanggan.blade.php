...
<div class="container-fluid py-4">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h5 class="text-center" style="margin-top: 20px"><b>DATA PENILAIAN</b></h5>
                            ...
                            @foreach ($pengaduans as $item)
                                <tr>
                                    ...
                                    <td class="align-middle" style="margin-right: 5px">
                                        <div class="d-flex">
                                            <a href="/pelanggan/penilaian/{{ $item->id }}/ratting" class="btn btn-warning"
                                                title="Edit Data">
                                                <i class="fas fa-star" style="color:rgb(13, 0, 255)"></i>
                                            </a>
