        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <a href="/admin/event/create" class="btn bg-gradient-primary">Tambah</a>
                </div>
                            ...
                            @foreach ($events as $item)
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="d-flex">
                                            <a href="/admin/event/{{ $item->id }}/edit" class="btn btn-info"
                                                title="Edit Data">
                                                <i class="fas fa-edit" style="color:rgb(13, 0, 255)"></i></a>
                                            <form onsubmit="return hapus(this);"
                                                action="/admin/event/{{ $item->id }}/hapus" method="POST"></a>
                                                @csrf
                                                @method('DELETE')
