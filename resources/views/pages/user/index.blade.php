            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <!--<a href="/admin/user/create" class="btn bg-gradient-primary">Tambah</a>-->
                    </div>
                    <div class="table-responsive" style="margin-top: -40px">
                        <table id="table" class="table align-items-center">
                            <thead>
                                <tr>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Level Id
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex">
                                                ...
                                                <a href="/admin/user/{{ $item->id }}/edit" class="btn btn-info"
                                                    title="Edit Data">
                                                    <i class="fas fa-edit" style="color:rgb(13, 0, 255)"></i></a>
                                                {{-- <form onsubmit="return hapus(this);" action="/admin/user/{{ $item->id }}/hapus" method="POST"></a>
                                                    @csrf
                                                    @method('DELETE')
