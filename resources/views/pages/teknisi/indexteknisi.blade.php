            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        {{-- <a href="/teknisi/teknisi/create" class="btn bg-gradient-primary">Tambah</a> --}}
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex">
                                                ...
                                                <a href="/teknisi/teknisi/{{ $item->id }}/edit" class="btn btn-info"
                                                    title="Edit Data">
                                                    <i class="fas fa-edit" style="color:rgb(13, 0, 255)"></i></a>
                                                {{-- <form onsubmit="return hapus(this);"
                                                    action="/teknisi/teknisi/{{ $item->id }}/hapus" method="POST"></a>
                                                    @csrf
                                                    @method('DELETE')
