    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <form method="POST" action="/admin/teknisi/{{ $teknisis->id }}/update" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="container-fluid py-4">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" name="nama_teknisi" class="form-control"
                                            ...
                                            value="{{ old('nama_teknisi') ?? $teknisis->nama_teknisi }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-3">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <div class="col-sm-12">
                                        <input type="text" name="notelp" class="form-control" placeholder="No Telpn"
                                            ...
                                            value="{{ old('notelp') ?? $teknisis->notelp }}"
