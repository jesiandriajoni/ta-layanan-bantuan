...
@section('navbar-judul', 'User')
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <h5 class="text-center" style="margin-top: 20px"><b>DATA USER</b></h5>
                    <div class="card-header">
                        {{-- <a href="/admin/pelanggan/create" class="btn bg-gradient-primary">Tambah</a> --}}
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex">
                                                ...
                                                <a href="/admin/pelanggan/{{ $item->id }}/edit" class="btn btn-info"
                                                    title="Edit Data">
                                                    <i class="fas fa-edit" style="color:rgb(13, 0, 255)"></i></a>
                                                <form onsubmit="return hapus(this);" action="/admin/pelanggan/{{ $item->id }}/hapus" method="POST"></a>
                                                    @csrf
                                                    @method('DELETE')
