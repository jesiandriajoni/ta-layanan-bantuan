        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header ml-5 float-right" style="margin-top: 50px">
                    <a href="/admin/pengaduan/create" class="btn bg-gradient-primary">Tambah</a>

                    <form action="/admin/cetakpengaduan" class="row">
                    ...
                    <div class="float-right d-flex justify-content-end">
                        <a href="/admin/pengaduan?status=waiting" class="btn bg-gradient-danger "
                            style="margin-right:4px">Menunggu</a>
                        <a href="/admin/pengaduan?status=doing"
                            class="btn bg-gradient-info mr-2"style="margin-right:4px">Dikerjakan</a>
                        <a href="/admin/pengaduan?status=done"
                            class="btn bg-gradient-success"style="margin-right:4px">Selesai</a>
                        <a href="/admin/pengaduan" All class="btn bg-gradient-secondary">Semua</a>
                    </div>
                </div>
                            ...
                            @foreach ($pengaduans as $item)
                                <tr>
                                    ...
                                    <td class="align-middle" style="margin-right: 5px">
                                        <div class="d-flex">
                                            <a href="/admin/pengaduan/{{ $item->id }}/edit" class="btn btn-info"
                                                title="Edit Data">
                                                <i class="fas fa-edit" style="color:rgb(13, 0, 255)"></i>
                                            </a>
                                            <form onsubmit="return hapus(this);"
                                                action="/admin/pengaduan/{{ $item->id }}/hapus" method="POST">
                                                </a>
                                                @csrf
                                                @method('DELETE')
