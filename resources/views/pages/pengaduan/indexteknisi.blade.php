                                ...
                                @foreach ($pengaduans as $item)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="d-flex">
                                                    @if ($item->status=='waiting')
                                                    <a href="/teknisi/pengaduan/{{ $item->id }}/accept" class="btn btn-danger"><i class="fas fa-play"></i></a>

                                                    @endif
                                                    @if ($item->status=='doing')
                                                    <a href="/teknisi/pengaduan/{{ $item->id }}/done" class="btn btn-info"><i class="fas fa-check"></i></a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
